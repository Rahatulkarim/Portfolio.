...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  header.hero:hover .grid-mark rect{ transform: scale(1.06); }
...
<header class="hero" id="top">
  <div class="wrap">
    ...
    <p class="role-line">Management Information Systems Student &amp; Data Analyst</p>
    <p class="objective">Undergraduate at the University of Dhaka focused on data analysis and AI-assisted workflows. Experience spans data cleaning, visualization and reporting using Excel, Power BI and Python, applied to real-world datasets.</p>
    <div class="hero-meta">
    ...
    <button class="hero-cta" id="hero-chat-btn" type="button">Ask a question about my background</button>
  </div>
</header>
...
<section id="interests" class="reveal">
  <div class="wrap">
    ...
    <p class="interest-line">Football and cricket, traveling, and reading informative books.</p>
  </div>
</section>
...
<div id="chat-panel" role="dialog" aria-label="Chat with Rahatul's assistant">
  <div class="chat-head">
    <div>
      <div class="chat-head-title">Portfolio Assistant</div>
      <div class="chat-head-sub">Resume-based Q&amp;A</div>
    </div>
...
(function(){
  ...
  var KB = {
    answers: [
      { keys: ["hi","hello","hey","assalam","salam"],
        reply: "Hello. I can answer questions about Rahatul's skills, education, certification, experience, or how to reach him." },
  ...
  function openChat(){
    ...
    if(!opened){
      opened = true;
      addMsg("Welcome. I can answer questions about Rahatul's skills, education, certification, experience, or how to get in touch.", 'bot');
      renderChips();
    }
